...
--// VISIBILITY CHECK (Raycast for walls, models, etc.)
local function isVisible(targetPart)
    ...
    if result and result.Instance then
        -- Ensure ray hits the target's character and not other parts
...
--// GET HEAD OR CREATE FAKE HEAD (for aiming)
local function getHeadTarget(character)
    ...
    local offsetY = 1.75 -- higher head aim
...
--// INPUT HANDLING (Right-click for aiming)
...
--// FOV GUI (Visual display of the FOV area)
